					...
					<tbody>
						...
						?>
							<tr>
								...
								<td>
									<?php if ($value['gaji_status'] == 'pending') : ?>
										<div class="badge badge-warning"><i class="ft-x-circle"></i> Pending</div>
									<?php elseif ($value['gaji_status' == 'terbayar']) : ?>
										<div class="badge badge-success"><i class="ft-check-circle"></i> Terbayar</div>
									<?php endif; ?>
								</td>
								<td>
									<button class="btn btn-success btn-sm  btn-bg-gradient-x-purple-blue box-shadow-2 gaji-lihat" data-toggle="modal" data-target="#lihat" value="<?= $value['gaji_id'] ?>" title="Lihat selengkapnya"><i class="ft-eye"></i></button>
									<?php if ($this->session->userdata('session_hak_akses') == 'manajer') : ?>
										<?php
										if ($value['gaji_status'] == 'belum') :
										?>
											<button class="btn btn-success btn-sm  btn-bg-gradient-x-purple-blue box-shadow-2 gaji-slip" data-toggle="modal" data-target="#slip" value="<?= $value['gaji_id'] ?>" title="Lihat slip gaji"><i class="ft-printer"></i></button>
											<button class="btn btn-success btn-sm  btn-bg-gradient-x-purple-blue box-shadow-2 gaji-bayar" data-toggle="modal" data-target="#bayar" value="<?= $value['gaji_id'] ?>" title="Sudah bayar ?"><i class="ft-check-square"></i></button>
										<?php
										else :
										?>
											<button class="btn btn-success btn-sm  btn-bg-gradient-x-purple-blue box-shadow-2 gaji-slip" data-toggle="modal" data-target="#slip" value="<?= $value['gaji_id'] ?>" title="Sudah bayar"><i class="ft-printer"></i></button>
											<button class="btn btn-success btn-sm  btn-bg-gradient-x-purple-blue box-shadow-2 gaji-bayar" data-toggle="modal" data-target="#bayar" value="<?= $value['gaji_id'] ?>" title="Sudah bayar" disabled><i class="ft-check-square"></i></button>
										<?php
										endif;
										?>
									<?php
