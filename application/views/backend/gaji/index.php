							...
							<tr>
								...
								<td>
									<?php if ($value['gaji_status'] == 'terbayar') : ?>
										<button class="btn btn-success btn-sm btn-bg-gradient-x-purple-blue box-shadow-2 gaji-slip" data-toggle="modal" data-target="#detail" data-id="<?= $value['karyawan_id'] ?>" title="Cetak slip"><i class="ft-printer"></i></button>
						...
						<div class="col-md-12">
							<div class="rekap_tetap">
								<div class="row">
									...
									<div class="col-md-6">
										<fieldset class="form-group floating-label-form-group">
											<label>Pinjam Ambil</label>
											<select name="hitung_rekap_pinjam_ambil" id="hitung_rekap_pinjam_ambil" class="form-control gaji_opsi_pinjaman_ambil">
												<option value=""></option>
											</select>
										</fieldset>
									</div>
									<div class="col-md-6">
										<fieldset class="form-group floating-label-form-group">
											<label>Pinjam Bayar</label>
											<select name="hitung_rekap_pinjam_bayar" id="hitung_rekap_pinjam_bayar" class="form-control gaji_opsi_pinjaman_bayar">
												<option value=""></option>
											</select>
										</fieldset>
									</div>
